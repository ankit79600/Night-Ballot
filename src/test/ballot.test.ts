...
// The simulator is auto-generated by `compact compile`.
// If this import fails, run `npm run compact` first.
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore — path exists only after compilation
import { BallotSimulator } from '../managed/ballot/contract/index.cjs';
...
describe('NightBallot — closeBallot', () => {
  ...
  it('rejects closeBallot with wrong organizer key', async () => {
    ...
    Object.assign(imposter.ledger, sim.ledger);
